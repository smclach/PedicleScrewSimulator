...
class PlanningGradeStep(PedicleScrewSimulatorStep):
  ...
  def __init__( self, stepid ):
    ...
    self.__parent = super( PlanningGradeStep, self )
  ...
  def onEntry(self, comingFrom, transitionType):
    ...
    super(PlanningGradeStep, self).onEntry(comingFrom, transitionType)
  ...
  def onExit(self, goingTo, transitionType):
    ...
    super(PlanningGradeStep, self).onExit(goingTo, transitionType)
