...
class PedicleScrewSimulator(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "PedicleScrewSimulator" # TODO make this more human readable by adding spaces
...
class PedicleScrewSimulatorLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('PedicleScrewSimulatorTest-Start','MyScreenshot',-1)
