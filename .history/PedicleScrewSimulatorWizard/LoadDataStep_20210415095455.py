...
class LoadDataStep(PedicleScrewSimulatorStep):
    ...
    def __init__( self, stepid ):
      ...
      self.setName( '1. 加载图卷' )
      self.setDescription( "加载图卷到当前场景。点击“从DICOM加载CT”yiLoad a volume into the scene. Click 'Load spine CT from DICOM' to open the DICOM browser window. Click 'Load spine CT from other file' to import other file types, including .nrrd" )
