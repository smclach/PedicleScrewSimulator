...
class LandmarksStep( PedicleScrewSimulatorStep ):
    ...
    def __init__( self, stepid ):
      ...
      self.setDescription( 'Place at least one fid on the spine to mark a screw insertion point.' )
    ...
    def validate( self, desiredBranchId ):
      ...
      #  if fidID != '':
      #    pNode = self.parameterNode()
      #    pNode.SetNodeReferenceID('fid', fidID)
          self.__parent.validationSucceeded(desiredBranchId)
      else:
          self.__parent.validationFailed(desiredBranchId, 'Error','Please place at least one fid on the model before proceeding')
