...
def createUserInterface( self ):
    ...
    self.screwcylGridBox = qt.QGridLayout()
    self.screwcylGridBox.addWidget(vText, 0, 0)
    self.screwcylGridBox.addWidget(self.vSelector, 1, 0)
    self.screwcylGridBox.addWidget(blank, 0, 1)
    self.screwcylGridBox.addWidget(iText, 0, 2)
    self.screwcylGridBox.addWidget(blank, 1, 1)
    self.screwcylGridBox.addWidget(self.iSelector, 1, 2)
    self.screwcylGridBox.addWidget(blank, 0, 3)
    self.screwcylGridBox.addWidget(sText, 0, 4)
    self.screwcylGridBox.addWidget(blank, 1, 3)
    self.screwcylGridBox.addWidget(self.sSelector, 1, 4)
    # self.screwcylGridBox.addWidget(aText,0,4)
    self.screwcylGridBox.addWidget(blank, 1, 5)
    # self.screwcylGridBox.addWidget(self.aSelector,1,4)
    self.__layout.addRow(self.screwcylGridBox)
